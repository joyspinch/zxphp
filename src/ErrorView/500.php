...
<div class="box">
	...
	<?php if (_CONF('debug')) { ?>
		<?php if (isset($error['file'])) { ?>
			...
			<pre style="margin-top:20px"> <?php echo $error['message'] ?></pre>
		<?php } else { ?>
			<h1 style="margin-top:20%;text-align: center;"><?php echo $result ?></h1>
		<?php } ?>
	<?php } else { ?>
		<h1>程序抛出了一个异常</h1>
		<pre style="margin-top:20px;text-align:center">程序猿刚刚被揍了，因为他写了这个BUG</pre>
	<?php } ?>
</div>
</body>
</html>
